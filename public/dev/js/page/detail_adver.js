$(function(){
    ...
    var recharge_box = new Box({
        ...
        fnSure: function(that,fn) {
            ...
            if (!base.formValidate($form)) {
                ...
                $.ajax({
                    url: "http://192.168.1.211:5211/back/adver/recharge",
                    type: "POST",
                    dataType: "json",
                    data: data
                }).done(function(data){
    ...
    var modify_box = new Box({
        ...
        fnSure: function(that,fn) {
            if (!base.formValidate($modifyForm)) {
                ...
                $.ajax({
                    url: "http://192.168.1.211:5211/back/adver/edit",
                    type: "POST",
                    dataType: "json",
                    data: data
                }).done(function(data){
    ...
    // 修改广告主弹框内容初始化
    modify_box.initContent('http://192.168.1.211:5211/back/page/adver_add .add_adver_form', function() {
    ...
    $("body").on('click', '.btn_edit', function() {
        ...
        var opt = {
            ...
            isLocal: true,
            theme: 'lightblue',
            url: "http://192.168.1.211:5211/back/adver/recharge_records?id="+adData.id
        };
