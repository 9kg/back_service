    ...
    $(function() {
        ...
        var box_docking = new Box({
            title:"接口",
            html:"http://192.168.1.211:5211/back/page/docking_add .docking_form",
        ...
        $(".content").on('click','.btn_remove',function(){
            ...
            box_docking.initContent('http://192.168.1.211:5211/back/page/docking_add .docking_form',function(){
                renderForm(id);
