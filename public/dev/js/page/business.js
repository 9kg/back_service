$(function() {
    ...
    $('body').on('click','table .btn_query_detail',function(){
        window.open('http://192.168.1.107:9211/html/detail/business_detail.html?id='+$(this).data('id'));
    }).on('click','.btn_business_add',function(){
        // 添加任务时 初始化弹窗标题及内容
        oper_business.box.initHeader('添加商务');

        oper_business.box.initContent('http://192.168.1.107:9211/html/temp/add_business.html .add_business_form', function() {
