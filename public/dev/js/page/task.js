$(function() {
    ...
    $('body').on('click','table .btn_query_detail',function(){
        // 跳转详情页
        window.open('http://192.168.1.107:9211/html/detail/task_detail.html?id='+$(this).data('id'));
        ...
        oper_task.box.initContent('http://192.168.1.107:9211/html/temp/add_task.html .add_task_form', function() {
            oper_task.box.show();
