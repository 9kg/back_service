$(function() {
    ...
    var opt = {
        ...
        // isLocal: true,
        footerFix: true,
        url: "http://192.168.1.211:9211/task/query",
        sendData: {
            page_size: 25,
            filter_key: 'name',
            sort: 'id',
    ...
    $('body').on('click','table .btn_query_detail',function(){
        ...
        window.open('http://192.168.1.211:9211/page/task_detail/'+id);
        ...
        var opt = {
            ...
            url: "http://192.168.1.211:9211/task/idfa_query"
        };
        ...
        if(!ids){
            ...
            confirm_tip.alertfn = function(flag){
                if(flag){
                    ...
                    $.ajax({
                        url: "http://192.168.1.211:9211/task/"+oper,
                        type: "POST",
                        dataType: "json",
                        data: sendData
                    }).done(function(data){
